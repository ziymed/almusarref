...
#-----------------------------------------
        ...
        self.TConjugation = wx.TextCtrl(self, -1, "", style=wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_RICH|wx.TE_RICH2)
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.CActiveFuture, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.CActivePast, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_10.Add(self.label_2, 0, wx.EXPAND, 0)
        sizer_10.Add(self.TRoot, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(sizer_10, 1, wx.EXPAND, 0)
        grid_sizer_1.Add(self.CPassiveFuture, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.CPassivePast, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_1.Add(self.CImperative, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.CAllTense, 0, wx.LEFT|wx.EXPAND|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_9.Add(grid_sizer_1, 1, wx.EXPAND, 0)
        sizer_8.Add(sizer_9, 1, wx.EXPAND, 0)
        sizer_8.Add(self.TConjugation, 0, wx.EXPAND, 0)
